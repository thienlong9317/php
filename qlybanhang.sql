...
-- Database: `qlybanhang`
--
CREATE DATABASE IF NOT EXISTS `qlybanhang` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `qlybanhang`;
...
INSERT INTO `nhomquantri` (`ma`, `ten`, `mota`, `trangthai`, `ngaytao`, `ngaycapnhat`) VALUES
(1, 'nhom 1', 'nhom 1', 1, '2021-01-15 00:00:00', NULL),
(2, 'nhom 2', 'nhom 2', 1, '2021-01-15 00:00:00', NULL);
...
(1, 'admin', 'admin', '123456', 2, 1, NULL, NULL, ''),
(2, 'admin2', 'admin2', '123456', 1, 2, NULL, NULL, '');
