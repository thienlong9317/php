                ...
                <thead class="thead-inverse">
                    ...
                    ?>
                        <tr>
                            ...
                            <td  class="text-right">
                            <a  class="btn btn-sm btn-primary" href="index.php?page=editqt&id=<?=$user->ma?>" role="button">
                            <i class="fa fa-pencil-square-o" aria-hidden="true"></i> Sửa</a>
                            <a onclick="return confirm('bạn có muốn xóa không?')" class="btn btn-sm btn-danger" href="index.php?page=delqt&id=<?=$user->ma?>" role="button">
